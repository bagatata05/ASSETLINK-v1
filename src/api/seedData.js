...
export const SEED_REPAIR_REQUESTS = [
    { id: 'rr_001', request_number: 'RR-100001', asset_id: 'ast_002', asset_name: 'Teacher\'s Desk (Wooden)', asset_code: 'DSK-001', school_name: 'Mabini Elementary School', reported_by_email: 'demo@assetlink.ph', reported_by_name: 'Juan Dela Cruz', description: 'Drawer handle broken, difficult to open. Splinters on the edge.', priority: 'Medium', status: 'Pending', created_date: '2025-11-20T08:00:00Z' },
    ...
    { id: 'rr_004', request_number: 'RR-100004', asset_id: 'ast_010', asset_name: 'Ceiling Fan', asset_code: 'FAN-001', school_name: 'Mabini Elementary School', reported_by_email: 'demo@assetlink.ph', reported_by_name: 'Juan Dela Cruz', description: 'Fan making loud grinding noise, blades wobbling dangerously. Safety hazard for students.', priority: 'Critical', status: 'Escalated', created_date: '2025-11-10T08:00:00Z', escalated_reason: 'Requires budget approval for replacement' },
    ...
    { id: 'rr_006', request_number: 'RR-100006', asset_id: 'ast_001', asset_name: 'Student Armchair (Monoblock)', asset_code: 'CHR-001', school_name: 'Mabini Elementary School', reported_by_email: 'demo@assetlink.ph', reported_by_name: 'Juan Dela Cruz', description: 'Armrest snapped off, chair is unstable.', priority: 'Low', status: 'Completed', created_date: '2025-09-12T08:00:00Z', completed_date: '2025-09-18T08:00:00Z' },
...
export const SEED_TASKS = [
    { id: 'tsk_001', asset_id: 'ast_002', asset_name: 'Teacher\'s Desk (Wooden)', asset_code: 'DSK-001', school_name: 'Mabini Elementary School', repair_request_id: 'rr_001', assigned_to_email: 'demo@assetlink.ph', assigned_to_name: 'Juan Dela Cruz', status: 'Assigned', priority: 'Medium', notes: 'Replace drawer handle and sand down splinters', created_date: '2025-11-21T08:00:00Z' },
    ...
    { id: 'tsk_003', asset_id: 'ast_007', asset_name: 'Air Conditioning Unit', asset_code: 'AC-001', school_name: 'Bonifacio Integrated School', repair_request_id: 'rr_005', assigned_to_email: 'demo@assetlink.ph', assigned_to_name: 'Juan Dela Cruz', status: 'Completed', priority: 'High', notes: 'Refilled refrigerant and fixed drain pipe', created_date: '2025-10-16T08:00:00Z', completed_date: '2025-10-25T08:00:00Z' },
    { id: 'tsk_004', asset_id: 'ast_001', asset_name: 'Student Armchair (Monoblock)', asset_code: 'CHR-001', school_name: 'Mabini Elementary School', repair_request_id: 'rr_006', assigned_to_email: 'demo@assetlink.ph', assigned_to_name: 'Juan Dela Cruz', status: 'Completed', priority: 'Low', notes: 'Replaced with spare chair from storage', created_date: '2025-09-13T08:00:00Z', completed_date: '2025-09-18T08:00:00Z' },
    // EXAMPLE: Task awaiting teacher verification (new feature)
    { id: 'tsk_005', asset_id: 'ast_003', asset_name: 'LCD Projector (Epson)', asset_code: 'PRJ-001', school_name: 'Mabini Elementary School', repair_request_id: 'rr_007', assigned_to_email: 'demo@assetlink.ph', assigned_to_name: 'Juan Dela Cruz', status: 'Pending Teacher Verification', priority: 'High', notes: 'Replaced light bulb and tested connectivity', created_date: '2025-12-01T08:00:00Z', verified_by_email: null, teacher_confirmation: false },
];
